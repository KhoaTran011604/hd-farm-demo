...
type FormFieldContextValue<TFieldValues extends FieldValues, TName extends FieldPath<TFieldValues>> = { name: TName };
const FormFieldContext = React.createContext<FormFieldContextValue<FieldValues, FieldPath<FieldValues>>>({} as FormFieldContextValue<FieldValues, FieldPath<FieldValues>>);
...
const FormControl = React.forwardRef<React.ElementRef<typeof Slot>, React.ComponentPropsWithoutRef<typeof Slot>>(({ ...props }, ref) => {
  ...
  return <Slot ref={ref} id={formItemId} aria-describedby={formMessageId} aria-invalid={!!error} {...props} />;
});
