...
| 4 | Mobile i18next + expo-localization setup | `phase-04-mobile-i18next-setup.md` | 1h | complete |
| 5 | Mobile app screens + language switcher | `phase-05-mobile-app-structure.md` | 1h | complete |
